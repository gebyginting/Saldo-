...
object DummyItems {
    val dummyCategoryItems = listOf(
        ...
        Category(name = "Other Expense", iconResId = R.drawable.ic_other_expense, type = TransactionType.EXPENSE, category = TransactionCategory.OTHER),
        ...
        Category(name = "Other Income", iconResId = R.drawable.ic_other_income, type = TransactionType.INCOME, category = TransactionCategory.OTHER),
        )
